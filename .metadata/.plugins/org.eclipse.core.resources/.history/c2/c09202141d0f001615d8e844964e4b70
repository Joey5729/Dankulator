...
public class Calculator {
	...
	protected void createContents() {
		...
		memoryMinus.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				
			}
		});
		memoryMinus.setBounds(741, 163, 69, 43);
		memoryMinus.setText("M-");
		
		Button memoryPlus = new Button(shell, SWT.NONE);
		memoryPlus.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
			}
		});
		memoryPlus.setBounds(660, 163, 69, 43);
